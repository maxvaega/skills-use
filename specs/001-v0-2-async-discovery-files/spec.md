...
A developer wants to organize skills across multiple directories: project-specific skills in `./skills/`, reusable Anthropic skills in `./.claude/skills/`, and third-party plugin skills in `./plugins/`. The skill manager should automatically discover and deduplicate skills from all configured sources.

**Why this priority**: Enables proper skill organization and reuse across projects. Critical for maintaining separation of concerns and supporting the Anthropic ecosystem.
